...
import Image_bouton from "./Image_bouton";
        ...
        {slideImages.map((slideImage, index) => (
          <div key={index} className="image-container">
            ...
            <div
              ...
              style={{
                top: slideImage.text_top + "%",
                left: slideImage.text_left + "%",
              }}
            >
              {slideImage.caption}
            </div>
...
function Page_body() {
  return (
    <div className="body">
      <Slideshow></Slideshow>
      <Spacer></Spacer>
      <div className="bouton_CV">
        <Image_bouton></Image_bouton>
      </div>
      <Spacer></Spacer>
    </div>
  );
...
function LoremIpsum() {
  return (
    <p class="LoremIpsum">
      ...
      lacus lorem varius purus. Curabitur eu amet. Lorem ipsum dolor sit amet,
      ...
      orci luctus et ultrices posuere cubilia Curae; Aliquam nibh. Mauris ac
      ...
      varius, ligula non tempus aliquam, nunc turpis ullamcorper nibh, in tempus
      sapien eros vitae ligula. Pellentesque rhoncus nunc et augue. Integer id
      felis. Curabitur aliquet pellentesque diam. Integer quis metus vitae elit
      ...
      magna. Aliquam convallis sollicitudin purus. Praesent aliquam, enim at
